...
import { Search, Filter, Users, Maximize, ArrowRight } from 'lucide-react';
import AOS from 'aos';
...
const AllRooms = () => {
    ...
    const categories = ["All", "Standard", "Suite", "Penthouse", "Villa", "Executive"];
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 px-6 lg:px-20">
            ...
            <div className="max-w-7xl mx-auto mb-16" data-aos="fade-down">
                ...
                <h1 className="text-white text-5xl md:text-7xl font-serif mt-4 mb-8 text-balance">Refined <br/>Accommodations</h1>
                    ...
                    >
                        ...
                        <div className="p-8">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <span className="text-[#b59473] text-[9px] uppercase tracking-[0.3em] font-bold">{room.brand}</span>
                                    <h3 className="text-white text-2xl font-serif mt-1">{room.type}</h3>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6 mb-8 py-4 border-y border-white/5">
                                <div className="flex items-center gap-2 text-gray-500 text-[10px] uppercase tracking-widest">
                                    <Users size={14} className="text-[#b59473]"/> {room.maxOccupancy.adults} Guests
                                </div>
                                <div className="flex items-center gap-2 text-gray-500 text-[10px] uppercase tracking-widest">
                                    <Maximize size={14} className="text-[#b59473]"/> {room.size}
                                </div>
                            </div>
